...
ct.inputs.addAction('NewAction', [{"code":"keyboard.Enter"}]);
...
ct.rooms.templates['game'] = {
    ...
    width: 1280,
    height: 720,
    objects: JSON.parse('[{"x":192,"y":384,"opacity":1,"tint":16777215,"scale":{"x":0.125,"y":0.125},"rotation":0,"exts":{},"customProperties":{},"template":"image-2019-02-19_000907"},{"x":896,"y":128,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":128,"y":-832,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":192,"y":128,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":1152,"y":-832,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":128,"y":-1216,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":1152,"y":-1216,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":1152,"y":576,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"slupek"},{"x":1152,"y":192,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"slupek"},{"x":960,"y":-64,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"slupek"},{"x":1152,"y":384,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"slupek"},{"x":64,"y":-832,"opacity":1,"tint":16777215,"scale":{"x":0.31406761,"y":0.31406761},"rotation":0,"exts":{},"customProperties":{},"template":"samochod"},{"x":1792,"y":128,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":2816,"y":128,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":192,"y":640,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":896,"y":640,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":1792,"y":640,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":2816,"y":640,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"lampa"},{"x":2176,"y":256,"opacity":1,"tint":16777215,"scale":{"x":0.30880579,"y":0.30880579},"rotation":0,"exts":{},"customProperties":{},"template":"samochod"}]'),
    bgs: JSON.parse('[{"texture":"street","depth":0,"exts":{"movementX":0,"movementY":0,"parallaxX":1,"parallaxY":1,"repeat":"repeat-x","scaleX":1,"scaleY":1,"shiftX":0,"shiftY":0}}]'),
    tiles: JSON.parse('[]'),
...
if (ct.camera.x - this.lastScreenX > 1280 && !ct.room.won) {
    ...
    bottom.depth = 5;
    this.lastScreenX = ct.camera.x;

    ct.templates.copy('skrzynia', ct.camera.x + 1280 + ct.random(ct.camera.width), ct.random.range(150, ct.camera.height));
    ct.templates.copy('skrzynia', ct.camera.x + 1280 + ct.random(ct.camera.width), ct.random.range(150, ct.camera.height));
    ct.templates.copy('skrzynia', ct.camera.x + 1280 + ct.random(ct.camera.width), ct.random.range(150, ct.camera.height));

    if (ct.random(3) < 1) {
        ct.templates.copy('samochod', ct.camera.x + 1280 + ct.random(ct.camera.width), 256)
    }
}
...
if (ct.actions['NewAction'].pressed) {
    let value = ct.actions['NewAction'].value;
...
ct.rooms.restart()
    ...
    onLeave() {
        /* room game — core_OnRoomEnd (On room end event) */
{
ct.sound.stop('music')
}
...
ct.rooms.templates['ui'] = {
    ...
    onStep() {
        /* room ui — core_OnStep (On frame start event) */
{
...
if (this.won) {
    this.textLabel.text = `Zdążyłeś na fajerwery`
    return;
}

if (ct.room.end) {
    this.textLabel.text = `Przypał, nie żyjesz. Naciśnij Enter, żeby zrestartować`
} else {
    this.textLabel.text = `Godzina: 23:59:${now.toString().padStart(2, '0')}, Pozostała odległość: ${150-distance}\nBiegnij na sylwestra`
}
    ...
    onCreate() {
        /* room ui — core_OnRoomStart (On room start event) */
{
this.textLabel = new PIXI.Text('Your text here', ct.styles.get('Zasuwaj na fajerwerki')); 
this.addChild(this.textLabel);
this.textLabel.x = 500;

this.start = Date.now();


this.instr = new PIXI.Text('Góra/Dół - poruszanie. Lewo - zwolnij. Prawo - przyśpiesz', ct.styles.get('Zasuwaj na fajerwerki')); 
...
ct.templates.templates["image-2019-02-19_000907"] = {
    depth: 2,
    ...
    loopAnimation: true,
    group: "ungrouped",
    texture: "DALL·E_2022-11-07_00.09.20",
    onStep: function () {
...
if (ct.room.won && !this.omg) {
    ct.emitters.follow(this, '2023')
    this.omg = true;
}

this.x += this.speedX * ct.delta;

if (this.speedX > this.defaultSpeedX && !this.isAccelerating) {
    this.speedX -= 0.1;
}

if (this.speedY > this.defaultSpeedY && !this.isAccelerating) {
    this.speedY -= 1;
}

this.animationSpeed = (1000 / this.defaultSpeedX) * this.speedX;
...
/* template image-2019-02-19_000907 — core_OnActionDown (OnActionDown event) */

if (ct.actions['MoveX'].down) {
    let value = ct.actions['MoveX'].value;
    
if (value < 0 && this.speedX > this.defaultSpeedX / 2) {
    this.speedX -= 0.1;
}
...
const result = this.y + this.speedY * value * ct.delta;
if (result > 100 && result < 650) {
    this.y += this.speedY * value * ct.delta;
}

if (ct.actions.Sprint.value === 1) {
    this.speedY = 25;
}

}
/* template image-2019-02-19_000907 — core_OnActionRelease (OnActionRelease event) */

if (ct.actions['MoveX'].released) {
...
this.isAccelerating = false;
    ...
    onCreate: function () {
        /* template image-2019-02-19_000907 — core_OnCreate (On create event) */
{
ct.camera.follow = this;
ct.camera.followY = false;
ct.camera.shiftX += 400;

this.defaultSpeedX = 10;
this.defaultSpeedY = 5;
...
ct.templates.list['image-2019-02-19_000907'] = [];
        
ct.templates.templates["vomet"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    ...
    texture: "vomet",
    onStep: function () {
        /* template vomet — core_OnStep (On frame start event) */
{
this.y += 8 * ct.delta;
}
...
ct.templates.templates["street"] = {
    ...
    texture: "street",
    onStep: function () {
        /* template street — core_OnStep (On frame start event) */
{
this.move();
}
...
ct.templates.list['street'] = [];
        
ct.templates.templates["lampa"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    texture: "lampa",
    onStep: function () {
        /* template lampa — core_OnStep (On frame start event) */
{
this.move();
this.depth = this.y;
}
...
ct.templates.list['lampa'] = [];
        
ct.templates.templates["slupek"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    texture: "slupek",
    onStep: function () {
        /* template slupek — core_OnStep (On frame start event) */
{
this.move();
this.depth = this.y;
}
...
ct.templates.list['slupek'] = [];
        
ct.templates.templates["samochod"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    texture: "path4594",
    onStep: function () {
        /* template samochod — core_OnStep (On frame start event) */
{
this.move();
this.scale.x = 0.30880579;
this.scale.y = 0.30880579;
this.depth = this.y;
}
...
ct.templates.templates["skrzynia"] = {
    ...
    texture: "skrzynia",
    onStep: function () {
        /* template skrzynia — core_OnStep (On frame start event) */
{
this.move();
this.depth = this.y;
}
...
(function resAddon(ct) {
    ...
    ct.res = {
        ...
        textures: {},
        skeletons: {},
        groups: [{"fonts":{"ungrouped":[]},"textures":{"ungrouped":["DALL·E_2022-11-07_00.09.20","vomet","street","light","lampa","slupek","path4594","skrzynia","particles","cloud","2023"]},"styles":{"ungrouped":["Zasuwaj na fajerwerki"]},"rooms":{"ungrouped":["game","ui"]},"templates":{"ungrouped":["image-2019-02-19_000907","vomet","Placeholder","street","lampa","slupek","samochod","skrzynia","NewTemplate"]},"sounds":{"ungrouped":["music"]},"emitterTandems":{"ungrouped":["2023"]}}][0],
        /**
        ...
        loadGame() {
            ...
            const atlases = [["./img/a0.json","./img/a1.json","./img/a2.json"]][0];
            const tiledImages = [{}][0];
            const sounds = [[{"name":"music","wav":"./snd/cHnbhdP5WqLF1N.wav","mp3":false,"ogg":false,"poolSize":5,"isMusic":true}]][0];
            const bitmapFonts = [{}][0];
